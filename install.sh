...
if [ "$SOURCE" = "remote" ]; then
  ...
  for f in send-to-codex.md read-from-codex.md ask-codex.md auto-plan.md auto-implement.md auto-full.md clean-comms.md fleet.md; do
...
echo ""
echo "  done! installed:"
echo "    Claude: /send-to-codex, /read-from-codex, /ask-codex, /auto-plan, /auto-implement, /auto-full, /clean-comms, /fleet"
